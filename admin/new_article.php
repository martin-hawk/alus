...
<section class="section-style w3-text-orange" style="width:66%;">
  <h3 style="border-bottom:solid thin #FF9800;">Kurti įrašą</h3>
  <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    <table class="w3-table" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td style="text-align:left;"><input type="text" name="title" size="32"></td>
        <td align="center" valign="bottom"><input type="submit" class="w3-btn w3-light-grey" name="save" value="Išsaugoti"></td>
      </tr>
    </table>
