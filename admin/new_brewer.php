...
&& $imageFileType != "gif" ) {
		...
		if ($uploadOk != 0) { 
			$sql = "INSERT INTO brewers (`image`, `name`, `show_name`, `description`, `show_description`) VALUES ('$image', '$name', '$show_name', '$description', '$show_description')";
...
<section class="section-style w3-text-orange" style="width:66%;">
  <h3 style="border-bottom:solid thin #FF9800;">Kurti aludarį</h3>
  ...
  <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <table class="w3-table" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td rowspan="2" align="center" valign="middle"><input type="submit" class="w3-btn w3-light-grey" name="save" value="Išsaugoti"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="text-align:left;"><input type="checkbox" value="1" name="show_name" checked>
